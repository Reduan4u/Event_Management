...
const AboutUs = () => {
    ...
    return (
        <div className="flex items-center py-20 bg-sky-50 bg-opacity-10">
            <div className="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-6 md:px-6">
                <div className="flex flex-wrap items-center">
                    <div className="w-full px-4 mb-10 xl:w-1/2 lg:mb-8" data-aos="fade-down"
                    >
                        <div className="flex flex-wrap">
                            <div className="w-full px-4 md:w-1/2">
                                <img src="https://i.postimg.cc/YCJW7jv8/pexels-fauxels-3184357.jpg" alt=""
                                    className="object-cover w-full mb-6 rounded-lg h-80 shadow-2xl" />
                                <img src="https://wpocean.com/html/tf/loveme/assets/images/product/7.jpg" alt=""
                                    className="object-cover w-full rounded-lg h-80 shadow-2xl" />
                            </div>
                            <div className="w-full px-4 md:w-1/2 xl:mt-11">
                                <img src="https://wpocean.com/html/tf/loveme/assets/images/product/5.jpg" alt=""
                                    className="object-cover w-full mb-6 rounded-lg h-80 shadow-2xl" />
                    ...
                    <div className="w-full px-4 mb-10 xl:w-1/2 lg:mb-8" data-aos="fade-up"
                    >
                        <span className="text-sm font-semibold text-blue-500">Why choose us</span>
