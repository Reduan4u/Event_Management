        ...
        <div>
            <div className="flex justify-center items-center">
                <div className="2xl:mx-auto 2xl:container lg:px-20 lg:py-16 md:py-12 md:px-6 py-9 px-4 w-96 sm:w-auto">
                    <h1 className="text-center text-gray-500 font-inter font-semibold text-2xl">Portfolio</h1>
                    <h1 className="text-center font-inter font-bold text-4xl my-4">OUR AMAZING WORK</h1>
