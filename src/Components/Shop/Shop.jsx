    ...
    return (
        <div>
            <div className="w-10/12 m-auto mt-10">
                <h1 className="text-center text-gray-500 font-inter font-semibold text-2xl">Our Shop</h1>
                <h1 className="text-center font-inter font-bold text-4xl my-4">SPECIAL PRODUCT FOR YOU</h1>
